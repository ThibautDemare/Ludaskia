...
const DEFINITIONS_ECRITES: readonly Definition[] = [
	...
	{ mot: 'sage', def: 'Un enfant très calme, qui ne fait jamais de bruit.' },
	...
	{ mot: 'femme', def: 'Une grande personne qui était une petite fille, autrefois.' },
	...
	{ mot: 'lever', def: 'Faire monter quelque chose.' },
	...
	{ mot: 'petit', def: 'Un objet qui tient facilement dans une seule main.' },
	...
	{ mot: 'reine', def: 'La femme qui gouverne un royaume tout entier.' },
	...
	{ mot: 'flotte', def: 'Un grand groupe de navires, réunis sur la mer.' },
	...
	{ mot: 'naitre', def: 'Sortir du ventre de sa maman, comme le fait un bébé.' },
	{ mot: 'navire', def: 'Un très grand véhicule qui traverse les océans.' },
	...
	{ mot: 'rapide', def: 'Un coureur qui va plus vite que tous les autres.' },
	...
	{ mot: 'épaule', def: 'L’articulation qui relie le bras au reste du corps.' },

	/* ---------- 7 lettres ---------- */
	{ mot: 'article', def: 'Le texte d’un journaliste dans un journal.' },
	{ mot: 'avancer', def: 'Aller vers l’avant, pas à pas.' },
	...
	{ mot: 'flotter', def: 'Bouger doucement dans le vent, comme un drapeau.' },
	{ mot: 'fromage', def: 'Un aliment fait avec du lait de vache.' },
	{ mot: 'fugitif', def: 'Quelqu’un qui s’enfuit très vite pour ne pas être attrapé.' },
	...
	{ mot: 'énergie', def: 'Ce qui permet de courir longtemps sans se fatiguer.' },
	...
	{ mot: 'ensemble', def: 'Plusieurs personnes réunies au même endroit.' },
